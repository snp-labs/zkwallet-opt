...
if (!latest) {
  throw new Error(
    "Could not resolve the requested latest snapshot for gate-failing regression history compare."
  );
}

if (!previous) {
  throw new Error(
    "Could not resolve the requested previous snapshot for gate-failing regression history compare."
  );
}
...
if (jsonOnly) {
  ...
  process.stdout.write(
    rewriteHeading(
      renderRegressionsHistoryComparisonText(payload),
