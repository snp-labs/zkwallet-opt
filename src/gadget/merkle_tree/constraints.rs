...
pub trait ConfigGadget<P: Config, ConstraintF: Field> {
    ...
    type LeafHash: CRHSchemeGadget<
        ...
        >;
    type TwoToOneHash: TwoToOneCRHSchemeGadget<P::TwoToOneHash, ConstraintF, OutputVar = Self::InnerDigest>;
}
    ...
    PathVar<P, ConstraintF, PG>
{
    ...
    pub fn update_leaf(
        ...
        self.calculate_root(leaf_params, two_to_one_params, new_leaf)
    }
    ...
    pub fn update_and_check(
        ...
        actual_new_root.is_eq(new_root)
    }
}
